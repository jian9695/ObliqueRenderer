...
public:
	 ...
	 static	double calculateAspect(osg::Vec3d normal);
		...
		static osg::Vec3d GrassSolar::solarAngle2Vector(double alt, double azimuth);
		...
		//SolarRadiation calculateSolarRadiation(SolarParam& solar_param, osg::Node* sceneNode, osgUtil::LineSegmentIntersector::Intersection intersection);

		SolarRadiation calculateSolarRadiation(SolarParam& solar_param, osg::Node* sceneNode, osg::Vec3d pos);

		SolarRadiation calculateSolarRadiation(SolarParam& solar_param, ShadowCaster* shadowCaster, osg::Vec3d pos);

		void calculateSolarRadiation(SolarParam& solar_param, osg::Node* sceneNode, ShadowCaster* shadowCaster, osg::Vec3d pos, std::vector<osg::Vec3>& rays);
